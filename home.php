...
?>
	...
	<link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.2.0/css/all.css" integrity="sha384-hWVjflwFxL6sNzntih27bfxkr27PmbbK/iSvJ+a4+0owXq79v+lsFkW54bOGbiDQ" crossorigin="anonymous">
	  ...
	  <body>
		...
		<nav class="navbar fixed-top static-top navbar-expand-lg navbar-light bg-light" id="navigation_bar" style="">
        ...
        <div class="container revs text-center text-light">
            ...
            <div id="carousel-example-generic" class="carousel slide" data-ride="carousel" data-interval="6000">
                <div class="carousel-inner" role="listbox">
                    <div class="carousel-item active">
                        <img src="images/testimonials1.jpg" id="testimonials1" class="rounded-circle pb-3" alt="First slide">
                    ...
                    <div class="carousel-item">
                        <img src="images/testimonials2.jpg" id="testimonials2" class="rounded-circle pb-3" alt="Second slide">
                    ...
                    <div class="carousel-item">
                        <img src="images/testimonials3.jpg" id="testimonials3" class="rounded-circle pb-3" alt="Third slide">
                        <h3>James Johnson</h3>
